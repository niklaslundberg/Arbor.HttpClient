...
All test projects use **xunit.v3**:

| Project | Framework | Runner | Notes |
|---|---|---|---|
| `Arbor.HttpClient.Core.Tests` | **xunit.v3** | Microsoft Testing Platform (MTP) | In-process execution |
| `Arbor.HttpClient.Storage.Sqlite.Tests` | **xunit.v3** | Microsoft Testing Platform (MTP) | In-process execution |
| `Arbor.HttpClient.Core.Integration.Tests` | **xunit.v3** | Microsoft Testing Platform (MTP) | In-process execution |
| `Arbor.HttpClient.Desktop.E2E.Tests` | **xunit.v3** | Microsoft Testing Platform (MTP) | Uses `Avalonia.Headless.XUnit` and assembly-level Avalonia test setup |
