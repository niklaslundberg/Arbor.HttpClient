...
2. **Modular dock registrations** ✅ Dockable decoupling complete (2026-06-14)
   ...
   - Optional follow-up: have `DockFactory` accept the context interfaces (or a registration list) rather than the concrete `MainWindowViewModel` — now a small mechanical change, since the coupling has been removed.
