...
| 5 | **Request panel VM** + retire `IRequestPanelContext` | `RequestPanelViewModel` owns tabs/editor/response projection; `RequestCompleted` drives History reload + cookie refresh. | High (response-projection surface) | **Next** |
