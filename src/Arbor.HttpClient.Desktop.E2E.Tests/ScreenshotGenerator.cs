...
public class ScreenshotGenerator
{
    ...
    private sealed class InMemoryCollectionRepo : ICollectionRepository
    {
        ...
        public Task InitializeAsync(CancellationToken cancellationToken = default) => Task.CompletedTask;
        public Task<int> SaveAsync(string name, string? sourcePath, string? baseUrl, IReadOnlyList<CollectionRequest> requests, CancellationToken cancellationToken = default, IReadOnlyList<RequestHeader>? headers = null) => Task.FromResult(1);
        public Task UpdateAsync(int collectionId, string name, string? sourcePath, string? baseUrl, IReadOnlyList<CollectionRequest> requests, CancellationToken cancellationToken = default, IReadOnlyList<RequestHeader>? headers = null) => Task.CompletedTask;
