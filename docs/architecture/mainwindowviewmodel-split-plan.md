...
`MainWindowViewModel` contains multiple feature areas and coordination responsibilities in one class (about 4,000 lines when this plan was written; about 3,040 lines as of 2026-06-12 after the request tabs + history slice). This slows down feature work, increases regression risk, and makes focused testing harder.
