...
/// <summary>
/// Returns white (<see cref="Brushes.White"/>) when the bound value is a valid non-empty hex color string
/// so that text on a colored environment dropdown meets WCAG 2.1 AA contrast (≥ 4.5:1).
/// Returns <see langword="null"/> when the value is null, empty, or not a valid color string,
/// allowing the control to fall back to its default foreground.
/// </summary>
public sealed class HexColorToForegroundConverter : IValueConverter
{
    ...
    public object? Convert(object? value, Type targetType, object? parameter, CultureInfo culture) =>
        ...
        Color.TryParse(hex, out _) ? Brushes.White : null;
